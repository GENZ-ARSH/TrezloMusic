...
API_KEY = getenv("API_KEY", '30DxNexGenBotsc3befe') # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/GENZ-ARSH",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/TREZLOSUPPORT")
